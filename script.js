...
if (typeof loveQuotes !== "undefined") allQuotes.push(...loveQuotes);
...
if (copyQuoteBtn) {
    copyQuoteBtn.addEventListener("click", () => {
        ...
        navigator.clipboard.writeText(randomQuote.textContent);

        copyQuoteBtn.textContent = "✅ کپی شد";

        setTimeout(() => {
            copyQuoteBtn.textContent = "📋 کپی متن";
        }, 1500);
